...
import { isTurnoTimeFocused } from "../../lib/booking/panel-now-focus";
import type { PanelAgendaBlockRow } from "../../lib/panel/panel-turno-helpers";
import { scopeLabel } from "../../lib/panel/panel-turno-helpers";

type PanelBlockCardProps = {
  block: PanelAgendaBlockRow;
...
export function PanelBlockCard({ block: b, selectedDateKey, onDelete }: PanelBlockCardProps) {
  ...
  const focused = isTurnoTimeFocused(b.timeLocal, selectedDateKey);
